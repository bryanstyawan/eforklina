	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				...
				<?php
					if ($this->session->userdata('session_role') == 4) {
						# code...
				?>
				<div class="box-tools pull-right"><button class="btn btn-block btn-primary" id="addData"><i class="fa fa-plus-square"></i> Permohonan Treating (Client)</button></div>
				<?php
					}
				?>				
			</div><!-- /.box-header -->
			<div class="box-body" id="table_fill">
				...
				<tr>
					<th>No</th>
					<th>Surat Permohonan Treating</th>
					<th>Nama, Tempat Tanggal Lahir</th>
					<th>Pihak Keluarga</th>
					<th>Penjamin Pembiayaan Yang Dimiliki</th>
				...
				<tbody>
					...
					<td>
						<button class="btn btn-primary btn-xs col-lg-12" style="margin-bottom:10px;" onclick="timeline(2,0)"><i class="fa fa-edit"></i> Timeline</button>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label>Surat Permohonan Treating (Nomor Surat)</label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Penjamin Pembiayaan</label>
							<select class="form-control" id="f_penjamin">
								<option></option>
							</select>
						</div>
					</div>
...
$(document).ready(function(){
	$("#addData").click(function()
	{
		...
		$("#formdata > div > div > div.box-header > h3").html("Permohonan Treating");		
		$("#crud").val('insert');
	})
...
function timeline(params,id) {
	...
	$("#viewdata").css({"display": "none"})
	$("#timelinedata > div > div > div.box-header > h3").html("Timeline Treating");	
}
