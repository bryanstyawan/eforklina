...
<!-- <section class="py-5" id="projects">
  <div class="container">
    ...
    <div class="row wow fadeInLeft" data-wow-delay=".3s">
      <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5"><img class="img-fluid rounded z-depth-2" src=" <?php echo base_url();?>assets_home/material/img/kuala-lumpur.jpg" alt="project image"/></div>
  ...
  <div class="container">
    ...
    <div class="row mb-lg-4 center-on-small-only">
      <div class="col-lg-6 col-md-12 mb-r wow fadeInLeft" data-wow-delay=".3s">
        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="<?php echo base_url();?>assets_home/material/img/woman-1.jpg" alt="team member"/></div>
      ...
      <div class="col-lg-6 col-md-12 mb-r wow fadeInRight" data-wow-delay=".3s">
        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="<?php echo base_url();?>assets_home/material/img/woman-2.jpg" alt="team member"/></div>
        <div class="col-md-6 float-right">
    ...
    <div class="row center-on-small-only">
      <div class="col-lg-6 col-md-12 mb-r wow fadeInLeft" data-wow-delay=".3s">
        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="<?php echo base_url();?>assets_home/material/img/man-1.jpg" alt="team member"/></div>
        <div class="col-md-6 float-right">
      ...
      <div class="col-lg-6 col-md-12 mb-r wow fadeInRight" data-wow-delay=".3s">
        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="<?php echo base_url();?>assets_home/material/img/man-2.jpg" alt="team member"/></div>
        <div class="col-md-6 float-right">
