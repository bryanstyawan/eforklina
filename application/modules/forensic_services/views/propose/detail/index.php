...
<div class="col-xs-5">
    <div class="box">
        ...
        <div class="box-footer">
            <a class="btn btn-success pull-right" id="btn-proses-yes-ksp"><i class="fa fa-save"></i>&nbsp; Lapor Ke Kabid</a>
        </div>
    </div><!-- /.box -->
</div>
<div class="col-xs-4">
    <div class="box">
        ...
        <div class="box-footer">
            <a class="btn btn-success pull-right" id="btn-propose"><i class="fa fa-save"></i>&nbsp; Usulkan</a>
        </div>
    </div><!-- /.box -->
</div>  
<?php
...
<script>
    $(document).ready(function(){        
        ...
        $("#btn-proses-yes-ksp").click(function() {
            var data_sender = {
			'remarks' : 'Telah memberikan usulan team dan melaporkanya ke Kepala Bidang'
		}		
            Lobibox.confirm({
                title: "Konfirmasi",
