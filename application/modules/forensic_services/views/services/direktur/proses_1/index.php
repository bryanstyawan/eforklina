...
<div class="col-xs-12">
    <div class="box">
        <div class="box-header">
            ...
            <h4 class="col-lg-12 text-center">Lanjutkan pemintaan layanan ini ?</h3>
            <div class="col-md-6"><a class="btn btn-danger pull-right" id=""><i class="fa fa-save"></i>&nbsp; tidak</a></div>
            <div class="col-md-6"><a class="btn btn-success pull-left" id="btn-proses-yes-dir"><i class="fa fa-save"></i>&nbsp; Ya</a></div>                        
        </div>
        <hr>
        <div class="box-body">
            <div class="row">
