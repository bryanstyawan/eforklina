			...
			<div class="box-header">
				...
				<?php
					if ($this->session->userdata('session_role') == 4) {
						# code...
				?>
					<div class="box-tools pull-right"><button class="btn btn-block btn-primary" id="addData"><i class="fa fa-plus-square"></i> Permohonan Escort (Client)</button></div>
				<?php
					}
				?>				
			</div><!-- /.box-header -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label>Surat Permohonan Escort</label>
...
$(document).ready(function(){
	$("#addData").click(function()
	{
		...
		$("#formdata > div > div > div.box-header > h3").html("Permohonan Escort");		
		$("#crud").val('insert');
	})
...
function timeline(params,id) {
	...
	$("#viewdata").css({"display": "none"})
	$("#timelinedata > div > div > div.box-header > h3").html("Timeline Escort");	
}
